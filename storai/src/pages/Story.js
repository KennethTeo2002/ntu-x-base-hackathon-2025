...
const Story = () => {
  ...
  const loadStory = async () => {
    try {
      ...
      const demoStory = {
        id: storyId,
        title: storyId === 'demo1' ? "Elara's Equation" : 
               storyId === 'demo2' ? "The Cosmic Discovery" :
               storyId === 'demo3' ? "Ocean's Secret" : "Generated Story",
        originalPrompt: storyId === 'demo1' ? "Write me a story about a scientist who discovered gravity" :
                       storyId === 'demo2' ? "Tell me about a space adventure" :
                       storyId === 'demo3' ? "Create a story about ocean mysteries" : "A magical adventure",
