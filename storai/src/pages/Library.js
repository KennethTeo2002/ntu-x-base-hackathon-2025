        ...
        original: [
          {
            ...
            description: 'A thrilling journey through the cosmos that I created yesterday.',
          ...
          },
          {
            ...
            description: 'An enchanting tale of mystical creatures and ancient magic.',
        ...
        borrowed: [
          {
            ...
            description: 'A brilliant scientist discovers the fundamental force that governs our universe.',
          ...
          },
          {
            ...
            description: 'Deep space explorers encounter signals from an unknown civilization.',
            image: 'https://images.unsplash.com/photo-1446776877081-d282a0f896e2?w=400&h=300&fit=crop&auto=format',
            type: 'borrowed'
          },
          {
            ...
            description: 'Ancient mysteries lie hidden in the deepest parts of our oceans.',
        ...
        <VStack align="stretch" spacing={8}>
          ...
          {filteredStories.length > 0 ? (
            <>
              ...
              {(activeFilter === 'all' || activeFilter === 'original') && stories.original.length > 0 && (
                <VStack align="stretch" spacing={4}>
                  <Heading size="lg" color="blue.500">
                    Original Stories
                  </Heading>
                  <Text color={subtitleColor} fontSize="sm">
                    Stories you've created and saved to your personal collection.
                  </Text>
              ...
              {(activeFilter === 'all' || activeFilter === 'borrowed') && stories.borrowed.length > 0 && (
                <VStack align="stretch" spacing={4}>
            ...
            <Center py={20}>
              <VStack spacing={4}>
                <Text fontSize="xl" color={subtitleColor}>
                  {activeFilter === 'original' ? 'No original stories yet' :
                   activeFilter === 'borrowed' ? 'No borrowed stories available' :
